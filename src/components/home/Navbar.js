    ...
    return (
        <div className='navbar' style={{ position: 'fixed', bottom: 0 , zIndex: 1000 }}>
            <div className='container-navbar'>
                <div className='icon'>
                    <a href="">
                        <img src={homeIcon} alt='Botão Tela inicial em formato de casa' ></img>
                        <p>Tela inicial</p>
                    </a>
                </div>
                ...
                <div className='icon'>
                    <a href="">
                        <img src={historicoIcon} alt='Botão Histórico em formato de relógio' ></img>
                        <p>Histórico</p>
                    </a>
                </div>
                ...
                <div className='icon'>
                    <a href="">
                        <img src={acessibilidadeIcon} alt='Botão de Acessibilidade em formato de uma pessoa' ></img>
                        <p>Acessibilidade</p>
                    </a>
                </div>
